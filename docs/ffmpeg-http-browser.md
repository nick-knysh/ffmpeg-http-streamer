...
- **`-t / --transcode`**: Same semantics as the main streamer when remux is not enough (H.264/AAC). Without it, output is stream copy (often smoother seeking and lower CPU; browsers need H.264/AAC for reliable in-page video).
